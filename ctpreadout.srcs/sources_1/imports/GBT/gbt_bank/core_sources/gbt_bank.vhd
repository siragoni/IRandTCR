...
entity gbt_bank is 
   generic (   
        ...
        TX_OPTIMIZATION           : integer range 0 to 1 := LATENCY_OPTIMIZED;--STANDARD;        --! TX_OPTIMIZATION: Latency mode for the Tx path (STANDARD or LATENCY_OPTIMIZED)
   ...
   port (   
        ...
        GBT_ISDATAGLAG_o         : out std_logic_vector(1 to NUM_LINKS);    --! Header Is data flag [Clock domain: GBT_RXFRAMECLK_i]
    ...
    gbt_rxdatapath_multilink_gen: for i in 1 to NUM_LINKS generate    
        ...
        gbt_rxdatapath_inst: entity work.gbt_rx            
            ...
            port map (    
                ...
                RX_ISDATA_FLAG_O                   => GBT_ISDATAGLAG_o(i),
