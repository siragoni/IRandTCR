...
package gbt_bank_package is  
   ...
   --================================= Array Declarations ================================-- 
	...
	-- 1D arrays
   type gbt_reg128_A                            is array (natural range <>) of std_logic_vector(127 downto 0);
   ...
   type gbt_reg20_A                             is array (natural range <>) of std_logic_vector(19 downto 0);
   ...
   type gbt_reg4_A								      is array (natural range <>) of std_logic_vector(3 downto 0);
	type gbt_reg3_A								      is array (natural range <>) of std_logic_vector(2 downto 0);
