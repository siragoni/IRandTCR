...
-- Custom libraries and packages:  -- Comment: LPM
...
entity gbt_tx_gearbox_std_dpram is
   port (
    ...
    --  RD_ADDRESS_I                              : in  std_logic_vector(  4 downto 0); -- Comment: by LPM 
      RD_ADDRESS_I                              : in  std_logic_vector(5 downto 0);     -- Comment: by LPM 
   ...
   --=====================================================================================--
     ...
     COMPONENT xlx_ku_tx_dpram
        PORT (
          ...
          clkb : IN STD_LOGIC;
      --    addrb : IN STD_LOGIC_VECTOR(4 DOWNTO 0);              -- Comment:  by LPM 
